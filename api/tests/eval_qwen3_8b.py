#!/usr/bin/env python3
"""Gold-set evaluation: qwen3:8b + verifier prompt v1.1.0.
...
from app.services.verifier import verify_top_k, VERIFIER_MODEL
...
def run_evaluation():
    ...
    # Save results
    output_path = os.path.join(os.path.dirname(__file__), "gold-set-report-qwen3-8b.json")
